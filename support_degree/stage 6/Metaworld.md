# Metaworld - Stage 6 (COMMUNICATE) Evaluation
...
Metaworld is a high-quality robotics benchmark environment suite with excellent environment implementations, expert policies, and comprehensive documentation of evaluation *methodology*. However, it is fundamentally not an evaluation framework and provides none of the Stage 6 COMMUNICATE features:
