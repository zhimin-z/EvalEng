...
## Capability 1: Output Format Validation
...
## Capability 2: Measurement Protocol Execution
...
## Capability 3: Output Result Validation
...
## Capability 4: Statistics Aggregation
...
## Capability 5: Baseline Comparison
...
## Capability 6: Uncertainty Quantification
...
**Report template:**
```
S3F6: Uncertainty Quantification
Grade: [Absent/Partial/Present] (XX% coverage)
Supports:
...
Documentation: [Minimal/Moderate/Comprehensive]
Evidence: [Link to CI implementation, statistical tests, uncertainty estimation, decomposition, propagation methodology]
```

---

## Capability 7: Fairness Assessment
