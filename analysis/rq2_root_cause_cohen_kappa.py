...
df_zhimin = pd.read_json(r"../data/rq2_issues_annotated_sample_zhimin.jsonl", lines=True)
df_zhimin = df_zhimin[df_zhimin['root_cause_label'].notna()]

# Load and filter data
df_zehao = pd.read_json("../data/rq2_issues_annotated_sample_zehao.jsonl", lines=True)
